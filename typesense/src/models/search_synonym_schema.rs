...
pub struct SearchSynonymSchema {
	...
	/// For 1-way synonyms, indicates the root word that words in the `synonyms`
	/// parameter map to.
	#[serde(rename = "root", skip_serializing_if = "Option::is_none")]
	pub root: Option<String>,
	/// By default, special characters are dropped from synonyms. Use this
	/// attribute to specify which special characters should be indexed as is.
